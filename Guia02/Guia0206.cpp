...
void doSquare( )
{
  ...
  //turnOff ( );  // MELHOR TIRAR, PARA NAO ENCERRAR PREMATURAMENTE
} // end doSquare( )
/**
...
int main ( )
{
  ...
  // executar tarefa
  // robot->moveI ( ); // EXPERIMENTAR TROCAR A ORDEM
  // executar tarefa
  robot->doSquare ( );
  // executar tarefa
  robot->moveI ( );   // POR EXEMPLO, AQUI FICARIA MELHOR
  // executar tarefa
   robot->doTask ( ); // RETIRAR ESSA PARTE, PARA TESTE
