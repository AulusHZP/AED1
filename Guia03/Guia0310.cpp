...
int main() {
  ...
  // executar tarefa
  char message[80];
  int quantidade = robot->readCommands(comandos, "Tarefa0310.txt");
  message[0] = '\0'; // limpar a mensagem
  sprintf(message, "Commands = %d", quantidade);
  show_Text(message);
  ...
  0.2 01. ( OK ) teste para contar comandos de arquivo
  0.3 01. ( OK ) teste para receber comandos de arquivo
  0.4 01. ( OK ) teste para executar um comando
  0.5 01. ( OK ) teste para executar comandos de arquivo
  0.6 01. ( OK ) teste para o robo explorar o mundo
  0.7 01. ( OK ) teste explorar o mundo e procurar marcadores
  0.8 01. ( OK ) teste para o robo explorar o mundo e fazer um mapa
  0.9 01. ( OK ) teste para guardar mapa em um arquivo
  0.10 01. ( OK ) teste para ler um mapa em arquivo
  */